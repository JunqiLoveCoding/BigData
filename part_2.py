    ...
    for file in db_list:
        ...
        for i, function in enumerate(functions):
            ...
            if (i == 8) or (i == 16):
                ...
                df_to_process.write.mode("overwrite").parquet("process.parquet")
                df_to_process = spark.read.parquet("process.parquet")
        ...
        df_complete = df_full.groupBy("sem_type").agg({"id": "count"})
        df_complete.show()
